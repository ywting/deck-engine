...
import { Briefcase, Expand, X } from 'lucide-react';
import enterpriseVideo from '../../assets/videos/enterprise-catalyst.webm';

export const EnterpriseVideoVisual: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full w-full relative overflow-hidden font-['Fira_Sans']">
      ...
      <button
        ...
        aria-label="Expand enterprise workshop recording"
      >
      ...
      {lightbox ? (
        createPortal(
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Enterprise workshop recording expanded view"
          >
            <button
              onClick={() => closeLightbox()}
