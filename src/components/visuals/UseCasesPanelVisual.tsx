...
import { FlaskConical, MonitorPlay, Expand, X } from 'lucide-react';
import skuCardRedesignVideo from '../../assets/videos/slide24-sku-card-redesign.webm';
import signinFlowVideo from '../../assets/videos/slide24-signin-flow.webm';
import nextgenPaymentVideo from '../../assets/videos/slide24-nextgen-payment.webm';
import pwaVideo from '../../assets/videos/slide24-pwa.webm';
...
interface PanelItem {
  ...
  name: string;
  detail: string;
  // VIDEO SLOT: import the recording clip and set `video` to enable
  // autoplay preview + click-to-expand lightbox for this use case, e.g.
  // import usecaseOms from '../../assets/videos/usecase-oms-promo.webm';
  video?: string;
}

const ITEMS: PanelItem[] = [
  {
    id: 'codm-sku-redesign',
    index: '01',
    name: 'COD:M SKU Card Redesign',
    detail:
      'Activision stakeholders reviewed and approved interactive card templates directly in the browser.',
    video: skuCardRedesignVideo,
  },
  {
    id: 'codm-signin',
    index: '02',
    name: 'COD:M Sign-In Flow',
    detail:
      'Prototyped the signed-in top-up flow with live session and identity states, resolving edge cases before engineering built it.',
    video: signinFlowVideo,
  },
  {
    id: 'fcm-payment-channel',
    index: '03',
    name: 'FCM Next-Gen Payment Channel',
    detail:
      'Validated the decoupled payment-channel step as a runnable flow with real channel logic and error states.',
    video: nextgenPaymentVideo,
  },
  {
    id: 'codm-pwa',
    index: '04',
    name: 'COD:M PWA Installation',
    detail:
      'Tested the install-to-homescreen journey and re-engagement loop as a working flow on real devices.',
    video: pwaVideo,
  },
];

export const UseCasesPanelVisual: React.FC = () => {
            ...
            >
              ...
              >
                ...
                <div className="mt-3 text-center text-[12px] font-['Fira_Code'] text-slate-300">
                  {active.name} — live prototype capture
                </div>
              </div>
            </div>,
            document.body
